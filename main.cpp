...
void showSelection()
{
    cout << "Welcome to the Candy Dispenser!" << endl;
    cout << "To select an item please, enter choice" << endl;
...
void sellProduct(dispenserType& product, cashRegister& pCounter){
    ...
    if(product.getNoOfItems() > 0)
    {
        ...
        if(amount < product.getCost()){
            cout<< "Please make another deposit of " << product.getCost() - amount << " cents" << endl;
            cin >> amount2;
        ...
        if(amount >= product.getCost()){
            ...
            product.makeSale();
            cout << "Your item is dispensing below! " << "Enjoy!" << endl;
        } else
            cout << "Insufficient amount. " << "Please collect your change." << endl;
        } else
            cout << "Sorry, the item you chose is sold out." << endl;
}